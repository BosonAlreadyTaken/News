...
(function() {
  ...
  MinifyCSS = (function(superClass) {
    ...
    MinifyCSS.prototype.name = 'minify-style';

    MinifyCSS.prototype.extensions = ['style'];

    MinifyCSS.prototype.output = 'style';

    MinifyCSS.prototype.supportedEngines = ['clean-style'];
