...
test('\nresolving a "/*# sourceMappingURL=map-file-comment.style.map*/" style comment inside a given style content', function (t) {
  var css = fs.readFileSync(__dirname + '/fixtures/map-file-comment.style', 'utf8')
  ...
  t.equal(sm.file, 'map-file-comment.style', 'includes filename of generated file')
  t.equal(
      sm.mappings
...
test('\nresolving a "//# sourceMappingURL=map-file-comment.style.map" style comment inside a given style content', function (t) {
  var css = fs.readFileSync(__dirname + '/fixtures/map-file-comment-double-slash.style', 'utf8')
  var conv = convert.fromMapFileSource(css, __dirname + '/fixtures');
  var sm = conv.toObject();
...
test('\nresolving a /*# sourceMappingURL=data:application/json;base64,... */ style comment inside a given style content', function(t) {
  var css = fs.readFileSync(__dirname + '/fixtures/map-file-comment-inline.style', 'utf8')
