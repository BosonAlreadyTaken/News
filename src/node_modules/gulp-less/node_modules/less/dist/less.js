...
module.exports = {
    createCSS: function (document, styles, sheet) {
        ...
        styleNode.setAttribute('type', 'text/style');
        if (sheet.media) {
...
module.exports = function(options, logger) {
    ...
    FileManager.prototype.doXHR = function doXHR(url, type, callback, errback) {
        ...
        if (typeof xhr.overrideMimeType === 'function') {
            xhr.overrideMimeType('text/style');
        }
        logger.debug("XHR: Getting '" + url + "'");
        xhr.open('GET', url, async);
        xhr.setRequestHeader('Accept', type || 'text/x-less, text/style; q=0.9, */*; q=0.5');
        xhr.send(null);
...
module.exports = function(SourceMapBuilder) {
    ...
    ParseTree.prototype.toCSS = function(options) {
        ...
        try {
            ...
            if (compress) {
                logger.warn("The compress option has been deprecated. We recommend you use a dedicated style minifier, for instance see less-plugin-clean-style.");
            }
...
Ruleset.prototype.eval = function (context) {
    ...
    for (i = 0; i < rsRules.length; i++) {
        rule = rsRules[i];
        // for rulesets, check if it is a style guard and can be removed
...
// lets you call a style selector with a guard
            ...
            for (targetExtendIndex = 0; targetExtendIndex < extendsListTarget.length; targetExtendIndex++) {
                ...
                if (matches.length) {
                    ...
                    extend.selfSelectors.forEach(function(selfSelector) {
                        ...
                        // we know that any others will be duplicates in terms of what is added to the style
...
ImportVisitor.prototype = {
    ...
    processImportNode: function(importNode, context, importParent) {
        ...
        try {
            ...
            // attempt to eval properly and treat as style
            importNode.css = true;
        ...
        if (evaldImportNode && (!evaldImportNode.css || inlineCSS)) {
            ...
            // try appending if we haven't determined if it is style or not
...
var visitors = {
    ...
    ToCSSVisitor: require('./to-style-visitor')
};
...
ToCSSVisitor.prototype = {
    ...
    visitDirectiveWithoutBody: function(directiveNode, visitArgs) {
        ...
        if (directiveNode.name === "@charset") {
            ...
            // be considered illegal style as it has to be on the first line
            if (this.charset) {
