...
//                require('../lib/less/lessc_helper').printUsage();
            ...
            case 'depends':
                ...
                break;
            case 'yui-compress':
                warningMessages += "yui-compress option has been removed. assuming clean-style.";
...
//    options.sourceMapBasepath = '';
    ...
    if (options.sourceMap === true) {
        ...
        if (!output && !sourceMapFileInline) {
            console.log("the sourcemap option only has an optional filename if the style filename is given");
            return;
        }
