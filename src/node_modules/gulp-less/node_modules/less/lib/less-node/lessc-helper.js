...
var lessc_helper = {
    ...
    printUsage: function() {
        ...
        console.log("  --source-map-map-inline  Puts the map (and any less files) as a base64 data uri into the output style file.");
        ...
        console.log("                           less-plugin. E.g. the clean style plugin is called less-plugin-clean-style");
        console.log("                           once installed (npm install less-plugin-clean-style), use either with");
        console.log("                           --plugin=less-plugin-clean-style or just --clean-style");
        console.log("                           specify options afterwards e.g. --plugin=less-plugin-clean-style=\"advanced\"");
        console.log("                           or --clean-style=\"advanced\"");
        console.log("");
        ...
        console.log("                           We recommend you use a dedicated minifer like less-plugin-clean-style");
        console.log("");
