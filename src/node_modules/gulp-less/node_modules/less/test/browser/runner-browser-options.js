...
var testFiles = ['charsets', 'colors', 'comments', 'style-3', 'strings', 'media', 'mixins'],
    testSheets = [];
...
// setup style tags with less and link tags pointing to expected style output

for (var i = 0; i < testFiles.length; i++) {
    var file = testFiles[i],
        lessPath  = '/test/less/' + file + '.less',
        cssPath   = '/test/style/' + file + '.style',
