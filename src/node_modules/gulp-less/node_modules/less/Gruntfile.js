...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        shell: {
            ...
            "sourcemap-test": {
                command: [
                    'node bin/lessc --source-map=test/sourcemaps/maps/import-map.map test/less/import.less test/sourcemaps/import.style',
                    'node bin/lessc --source-map test/less/sourcemaps/basic.less test/sourcemaps/basic.style'
                ].join('&&')
            }
        },
        ...
        clean: {
            ...
            "sourcemap-test": ['test/sourcemaps/*.style', 'test/sourcemaps/*.map'],
            sauce_log: ["sc_*.log"]
        }
    });
